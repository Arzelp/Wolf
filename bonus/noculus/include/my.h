...
** Last update Thu Dec 22 15:38:41 2016 Paskal Arzel
*/
...
#define X_SPRINT 50
#define Y_SPRINT 750
#define SIZE_SPRINT 10
#define TEXTURE_MIN 20
#define WIDTH 800
#define HEIGHT 800
#define SMG_CD 3
...
#define NB_WEAPONS 1
#define NB_MOBS 1
#define START_WEAPON_X (WIDTH * 3 / 4)
#define START_WEAPON_Y (HEIGHT * 3 / 4)
...
{
  t_bunny_window	*win;
  t_bunny_pixelarray	**weapons_sprite;
  t_bunny_pixelarray	**weaponson_sprite;
  t_weapon		weapon;
  t_block		block;
  t_mob			**mobs;
  char			*name;
